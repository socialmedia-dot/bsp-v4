    ...
    <aside class="sidebar" :class="{ open: isOpen }">
      <nav class="sidebar-nav">
        <div class="nav-section">
          <div class="nav-section-title">Business Portal</div>
          <NuxtLink to="/business-portal/dashboard" :class="['nav-item', { active: active === 'dashboard' }]" @click="close">
            <span class="nav-icon">📊</span><span>Dashboard</span>
          </NuxtLink>
          <NuxtLink to="/business-portal/profile" :class="['nav-item', { active: active === 'profile' }]" @click="close">
            <span class="nav-icon">🏢</span><span>Business Profile</span>
          </NuxtLink>
          <NuxtLink to="/business-portal/partnerships" :class="['nav-item', { active: active === 'partnerships' }]" @click="close">
