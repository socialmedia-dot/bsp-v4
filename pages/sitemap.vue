...
const applicationPhases = [
  ...
  { num: 3, name: 'Offering', desc: 'School sends deposit form, student pays and uploads proof, school confirms' },
  { num: 4, name: 'Admission Documents', desc: 'Collect official documents, references, medical forms, and agreements' },
  { num: 5, name: 'Pre-Departure', desc: 'CAS letter issued, visa application, and travel arrangements' },
]
