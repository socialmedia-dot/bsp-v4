              ...
              <tr v-for="app in paginatedApplications" :key="app.id" class="user-row">
                ...
                <td class="td-actions">
                  <div class="action-buttons">
                    ...
                    <button v-if="can('approveApplications')" class="btn-action btn-approve" @click="approveApplication(app.id)" title="Approve">
                      ✅
                    </button>
                    <button v-if="can('approveApplications')" class="btn-action btn-reject" @click="rejectApplication(app.id)" title="Reject">
                      ❌
                    </button>
              ...
              <tr v-for="app in paginatedApplications" :key="app.id" class="user-row deleted-row">
                ...
                <td class="td-actions">
                  <div class="action-buttons">
                    ...
                    <button v-if="can('approveApplications')" class="btn-action btn-approve" @click="acceptApplication(app.id)" title="Accept">
                      ✅
                    </button>
                  </div>
                </td>
    ...
    <div v-if="showPanel" class="detail-panel-overlay" @click.self="closePanel">
      <div class="detail-panel">
        ...
        <div class="panel-footer">
          ...
          <button v-if="selectedApplication && selectedApplication.status === 'pending' && can('approveApplications')" class="btn btn-danger" @click="rejectFromPanel">
            ❌ Reject
          </button>
          <button v-if="selectedApplication && selectedApplication.status === 'pending' && can('approveApplications')" class="btn btn-primary" @click="approveFromPanel">
            ✅ Approve
          </button>
          <button v-if="selectedApplication && selectedApplication.status === 'rejected' && can('approveApplications')" class="btn btn-primary" @click="acceptFromPanel">
            ✅ Accept
          </button>
        </div>
      </div>
...
// Permission matrix aligned with dashboard.vue
